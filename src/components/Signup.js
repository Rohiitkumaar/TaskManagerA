    ...
    <div className="flex justify-center items-center h-screen bg-gray-900">
      ...
      >
        ...
        <input
          ...
          className="w-full p-3 mb-4 border border-gray-300 rounded-md text-gray-900 focus:outline-none focus:border-green-500"
        />
        ...
        <input
          ...
          className="w-full p-3 mb-6 border border-gray-300 rounded-md text-gray-900 focus:outline-none focus:border-green-500"
        />
